...
$('#need-index-link').attr("href", "index.html?ods=" + ods + "&comparitor=" + comparitor + "&denominator=needIndex")
$('#total-population-link').attr("href", "index.html?ods=" + ods + "&comparitor=" + comparitor + "&denominator=TOTAL_PATIENTS")
$('#raw-link').attr("href", "index.html?ods=" + ods + "&comparitor=" + comparitor + "&denominator=raw")

//Set type
if (comparitor == 'ccg') {
    $('#comparison-type').html('CCG mode')
    $('#change-comparison').html('Switch to Nearest Neighbour Mode')
    $('#change-comparison').attr("href", "index.html?ods=" + ods + "&comparitor=nearestNeighbour&denominator=" + denominator)
} else {
    $('#comparison-type').html('Nearest Neighbour mode')
    $('#change-comparison').html('Switch to CCG Mode')
    $('#change-comparison').attr("href", "index.html?ods=" + ods + "&comparitor=ccg&denominator=" + denominator)
}